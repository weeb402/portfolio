    ...
    <section id="dossiers" className="border-y border-bond-border bg-bond-panel/40 py-24">
      <div className="mx-auto max-w-6xl px-6">
        <p className="telemetry">
          <ScrambleText text="Section 03 // Declassified Mission Dossiers // ADR Format" />
        </p>
        <h2 className="mt-3 font-cormorant text-4xl font-semibold text-neutral-100 sm:text-5xl">
          <ScrambleText text="Architecture decision records" />
        </h2>
            ...
            <Reveal key={d.id} delay={i * 90}>
              <Card3D maxTilt={4} glare={false}>
                <button
                  ...
                  className="group flex w-full flex-col gap-3 border border-bond-border bg-bond-panel p-6 text-left transition-colors hover:border-bond-gold/50 hover:bg-bond-panel/60 sm:flex-row sm:items-center sm:gap-8 sm:p-8"
                >
